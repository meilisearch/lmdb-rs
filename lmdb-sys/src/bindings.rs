...
pub const MDB_ALWAYSFREEPAGES: ::libc::c_uint = 67108864;
...
extern "C" {
    ...
    #[doc = "\t<li>MDB_ALWAYSFREEPAGES"]
    #[doc = "\t\tAlways free single pages instead of keeping them in a list, for future"]
    #[doc = "\t\treuse. This can make some small transactions a little bit slower because"]
    #[doc = "\t\tof the need to always ask malloc for new pages but it has the advantage"]
    #[doc = "\t\tof reducing the memory usage when LMDB is not used. Sometimes when LMDB"]
    #[doc = "\t\tas just committed a transaction with a lot of pages, a lot of memory is"]
    #[doc = "\t\tstill used and can only be freed when the environment is closed."]
    #[doc = " </ul>"]
