...
pub const MDB_SIZE_MAX: ::libc::c_ulonglong = 18446744073709551615;
...
pub const MDB_VERSION_DATE: &'static [u8; 12usize] = b"May 1, 2017\0";
...
>;
#[doc = " @brief A callback function used to encrypt/decrypt pages in the env."]
#[doc = ""]
#[doc = " Encrypt or decrypt the data in src and store the result in dst using the"]
#[doc = " provided key. The result must be the same number of bytes as the input."]
#[doc = " @param[in] src The input data to be transformed."]
#[doc = " @param[out] dst Storage for the result."]
#[doc = " @param[in] key An array of three values: key[0] is the encryption key,"]
#[doc = " key[1] is the initialization vector, and key[2] is the authentication"]
#[doc = " data, if any."]
#[doc = " @param[in] encdec 1 to encrypt, 0 to decrypt."]
...
>;
#[doc = " @brief A callback function used to checksum pages in the env."]
#[doc = ""]
#[doc = " Compute the checksum of the data in src and store the result in dst,"]
#[doc = " An optional key may be used with keyed hash algorithms."]
#[doc = " @param[in] src The input data to be transformed."]
#[doc = " @param[out] dst Storage for the result."]
#[doc = " @param[in] key An encryption key, if encryption was configured. This"]
#[doc = " parameter will be NULL if there is no key."]
...
extern "C" {
    #[doc = " @brief Set the size of DB pages in bytes."]
    #[doc = ""]
    #[doc = " The size defaults to the OS page size. Smaller or larger values may be"]
    #[doc = " desired depending on the size of keys and values being used. Also, an"]
    #[doc = " explicit size may need to be set when using filesystems like ZFS which"]
    #[doc = " don't use the OS page size."]
...
extern "C" {
    #[doc = " @brief Set encryption on an environment."]
    #[doc = ""]
    #[doc = " This must be called before #mdb_env_open()."]
    #[doc = " It implicitly sets #MDB_REMAP_CHUNKS on the env."]
    #[doc = " @param[in] env An environment handle returned by #mdb_env_create()."]
    #[doc = " @param[in] func An #MDB_enc_func function."]
    #[doc = " @param[in] key The encryption key."]
    #[doc = " @param[in] size The size of authentication data in bytes, if any."]
    #[doc = " Set this to zero for unauthenticated encryption mechanisms."]
    #[doc = " @return A non-zero error value on failure and 0 on success."]
...
extern "C" {
    #[doc = " @brief Set checksums on an environment."]
    #[doc = ""]
    #[doc = " This must be called before #mdb_env_open()."]
    #[doc = " @param[in] env An environment handle returned by #mdb_env_create()."]
    #[doc = " @param[in] func An #MDB_sum_func function."]
    #[doc = " @param[in] size The size of computed checksum values, in bytes."]
    #[doc = " @return A non-zero error value on failure and 0 on success."]
...
extern "C" {
    ...
    #[doc = " @note Names are C strings and stored with their NUL terminator included."]
    #[doc = " In LMDB 0.9 the NUL terminator was omitted."]
    #[doc = ""]
    #[doc = " @param[in] txn A transaction handle returned by #mdb_txn_begin()"]
...
extern "C" {
    #[doc = " @brief Check if the cursor is pointing to a named database record."]
    #[doc = ""]
    #[doc = " @param[in] cursor A cursor handle returned by #mdb_cursor_open()"]
    #[doc = " @return 1 if current record is a named database, 0 otherwise."]
...
#[doc = " @brief A function for converting a string into an encryption key."]
#[doc = ""]
#[doc = " @param[in] passwd The string to be converted."]
#[doc = " @param[in,out] key The resulting key. The caller must"]
#[doc = " provide the space for the key."]
#[doc = " @return 0 on success, non-zero on failure."]
pub type MDB_str2key_func = ::std::option::Option<
    unsafe extern "C" fn(passwd: *const ::libc::c_char, key: *mut MDB_val) -> ::libc::c_int,
>;
#[doc = " @brief A structure for dynamically loaded crypto modules."]
#[doc = ""]
#[doc = " This is the information that the command line tools expect"]
#[doc = " in order to operate on encrypted or checksummed environments."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " @brief The function that returns the #MDB_crypto_funcs structure."]
#[doc = ""]
#[doc = " The command line tools expect this function to be named \"MDB_crypto\"."]
#[doc = " It must be exported by the dynamic module so that the tools can use it."]
#[doc = " @return A pointer to a #MDB_crypto_funcs structure."]
